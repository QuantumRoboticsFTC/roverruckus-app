...
public class AutoPaths {
    ...
    public static double LEFT_SECOND_DEPOT = 37;
    public static double LEFT_SECOND_CRATER = 20;
    public static int LEFT_SECOND_EXTEND = 0;
    public static double CENTER_SECOND_DEPOT = 31;
    public static double CENTER_SECOND_CRATER = -9;
    public static int CENTER_SECOND_EXTEND = -300;
    public static double RIGHT_SECOND_DEPOT = 14;
    public static double RIGHT_SECOND_CRATER = -38;
    public static int RIGHT_SECOND_EXTEND = -650;
    ...
    public static Pose2d CRATER_DOUBLE = new Pose2d(3, 46, 165.0 * (PI / 180));
